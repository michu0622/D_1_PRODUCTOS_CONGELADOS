...
public class PRODUCTOCONGELADO {
    ...
    String pais;
     ...
     public PRODUCTOCONGELADO (String nombre,String fecha_envasado,String fecha_caducidad,String numero_lote,String pais){
        this.nombre=nombre;
    ...
    public String MostrarproductoCongelado(){
